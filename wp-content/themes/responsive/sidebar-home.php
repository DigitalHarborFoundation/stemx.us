      ...
      <!--  <div class="grid col-300">
       ...
       <!-- </div> --><!-- end of .col-300 --> 
        ...
        <?php responsive_widgets(); // above widgets hook ?>
            ...
            <div class="widget-wrapper-twitter">
			...
			</div><!-- end of .widget-wrapper (which is now called widget-wrapper-twitter) -->
			<?php endif; //end of home-widget-3 ?>
            
        <?php responsive_widgets_end(); // after widgets hook ?>
        </div><!-- end of .col-300 fit  (which is now called twitter-wrapper) -->
    </div><!-- end of #widgets -->